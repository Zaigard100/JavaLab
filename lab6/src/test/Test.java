...
import java.util.*;
import java.util.LinkedList; import java.awt.*;
...
class Balls extends Frame implements Observer, ActionListener, ItemListener {
    ...
    public void update(Observable o, Object arg) {
        Ball ball = (Ball)arg;
        System.out.println ("x= " + ball.thr.getName() + ball.x); repaint();
    }
    ...
    public void actionPerformed (ActionEvent aE) {
        ...
        if (str.equals ("OK")){
            ...
            LL.add(ball); ball.addObserver(this);
        } repaint();
    }
}
